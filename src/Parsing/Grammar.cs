...
internal static class Grammar
{
    ...
    {
        "grf", "param", "var", "cargotable", "railtypetable", "roadtypetable", "tramtypetable", "if", "else",
        "while", "item", "property", "graphics", "livery_override", "snowline", "basecost", "template", "spriteset",
        "spritegroup", "switch", "random_switch", "produce", "error", "disable_item", "replace", "replacenew",
        "font_glyph", "deactivate", "town_names", "string", "return", "exit", "tilelayout", "spritelayout",

...
/// <summary>
/// The wrapper class for effecting conversion of sorted position sequences.
/// </summary>
/// <param name="lineLengths"></param>
internal struct PositionConverter(List<int> lineLengths)
{
    private int _line = 0;
    ...
    public PositionConverter Copy()
        => new(lineLengths)
        {
            ...
            _offset = _offset,
            _linesInfo = _linesInfo is null ? null : [.. _linesInfo]
        };
